...
export const footerInfo = [
    {icon: faBuffer, info1: 'APNA DOST', id: 1},
    {icon: faMobileAlt, info1: '+91 6350xxxxxx', info2: 'madhur@gmail.com', id: 2},
    {icon: faMapMarkedAlt, info1: 'Jaipur, Inida', info2: 'XX', id: 3}
];